...
| Process (include page number and figure number) | Can occur in allopatric populations (yes or no) | Can occur in sympatric populations (yes or no) |
| --- | --- | --- |
| Sexual selection (Figure 24.12) | Yes | Yes |
| blank | blank | blank |
...
In this chapter, you will learn about mechanisms that can lead to speciation, the process by which one species splits into two or more species. Before beginning this chapter, you should be able to do the following:

- Distinguish meiosis from mitosis (see Figure 13.10).
- Explain the chromosomal basis of inheritance (see Figure 15.4 and Concept 15.1).
- Describe how mutation, gene flow, genetic drift, and natural selection affect allele frequencies in populations (see Concept 23.3).
...
1. Which of the following statements about meiosis is correct?
            ...
            In meiosis, each cell division produces two genetically identical daughter cells.


That's incorrect. Try again.


**Incorrect.** Review the following material: Meiosis in a diploid cell produces two haploid cells. In meiosis, the independent assortment of homologous chromosomes results in each daughter cell receiving one of  2n (where  n is the haploid chromosome number) possible combinations of the maternal and paternal chromosomes. Crossing over may occur during meiosis, thereby producing recombinant chromosomes that carry genes derived from two different parents.


            Meiosis in a diploid cell produces diploid daughter cells.
...
**Correct!** If you had trouble with this question, review the following material: Meiosis in a diploid cell produces two haploid cells that differ genetically from one another and from the diploid parent cell. This occurs in part because in meiosis, the independent assortment of homologous chromosomes results in each daughter cell receiving one of  2n (where  n is the haploid chromosome number) possible combinations of the maternal and paternal chromosomes. Another reason is that crossing over may occur during meiosis, thereby producing recombinant chromosomes that carry genes derived from two different parents.
            ...
            Crossing over cannot occur during meiosis.
...
gene flow (after the species became established on Island  B).
...
- 24.1Define the biological species concept, and identify reproductive barriers that could isolate a species' gene pool from that of other species.
- 24.2Compare and contrast allopatric speciation and sympatric speciation.
- 24.3Explain what a hybrid zone is, and identify possible outcomes for a hybrid zone over time.
- 24.4Give examples that show how speciation can occur rapidly or slowly, and can result from changes in few or many genes.
