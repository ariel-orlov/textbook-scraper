...
In this chapter, you will learn how plants have mechanisms for sensing abiotic and biotic changes in their environment, integrating this information, and responding appropriately, often by altering their growth pattern. Before beginning this chapter, you should be able to do the following:

- Describe how scientists study light-dependent processes (see Concept 10.2 and Figure 10.9).
- Describe the basic steps of signal transduction (see Concept 11.3).
- Describe the structure of the plant cell wall (see Concept 6.7 and Figure 6.27).

The following questions provide a quick check of your basic knowledge in these areas.


1. An action spectrum is best described as


            the amount of energy that reactants must absorb before a chemical reaction can begin.


That's incorrect. Try again.


**Incorrect.** Review the following material: Physiologists who study how organisms respond to light will often create an action spectrum, a graph of how a particular light-sensitive process is affected by different wavelengths of light.


            a graph of the absorption of light by isolated molecules.
...
**Incorrect.** Review the following material: Physiologists who study how organisms respond to light will often create an action spectrum, a graph of how a particular light-sensitive process is affected by different wavelengths of light.
            ...
            a propagating electrical signal.
...
**Correct!** If you had trouble with this question, review the following material: Physiologists who study how organisms respond to light will often create an action spectrum, a graph of how a particular light-sensitive process is affected by different wavelengths of light.


2. The term *second messengers* refers to
...
**Correct!** If you had trouble with this question, review the following material: Cascades of molecular interactions relay signals from receptors to target molecules in the cell. Second messengers relay a signal to a cell’s interior in response to a signal interacting with a cell receptor.


            chemical messengers of secondary importance.


That's incorrect. Try again.


**Incorrect.** Review the following material: Cascades of molecular interactions relay signals from receptors to target molecules in the cell. Second messengers relay a signal to a cell’s interior in response to a signal interacting with a cell receptor.


            chemical messengers that are transported throughout the organism.
...
**Incorrect.** Review the following material: Cascades of molecular interactions relay signals from receptors to target molecules in the cell. Second messengers relay a signal to a cell’s interior in response to a signal interacting with a cell receptor.
            ...
            chemical messengers that evolved after primary messengers.
...
3. Which one of the following statements about cell walls is true?


            The plant cell wall is inflexible.


That's incorrect. Try again.


**Incorrect.** Review the following material: Plant cell walls prevent the plant protoplast from lysing due to an excessive uptake of water by osmosis. The pushing of the protoplast against the cell wall is called turgor pressure.
...
**Correct!** If you had trouble with this question, review the following material: Plant cell walls prevent the plant protoplast from lysing due to an excessive uptake of water by osmosis. The pushing of the protoplast against the cell wall is called turgor pressure.


            The plant cell wall is made exclusively of cellulose.
...
**Incorrect.** Review the following material: Plant cell walls prevent the plant protoplast from lysing due to an excessive uptake of water by osmosis. The pushing of the protoplast against the cell wall is called turgor pressure.
            ...
            Plant cells are unique in having cell walls.
...
- 39.1Trace the steps of a signal transduction pathway in a plant.
- 39.2Identify plant hormones and their functions.
- 39.3Describe plant responses to light.
- 39.4Give examples that show how plants respond to stimuli.
- 39.5Describe plant defenses against herbivores and pathogens.
...
![Light-induced de-etiolation (greening) of dark-grown potatoes is explained in 2 figures.](../images/img_0.jpg)
...
![A general model for signal transduction pathways showing reception by a receptor at the cell wall is given; transduction via relay proteins in the cytoplasm and response.](../images/img_1.jpg)
...
![Light signal detected by phytochrome receptor, which then activates at least two signal transduction pathways, one using c G M P as a second messenger and the other increases the cytosolic level of C a superscript 2 plus.](../images/img_2.jpg)
...
- What are the physical differences between dark- and light-grown plants? Explain how etiolation helps a seedling compete successfully.
- Cycloheximide is a drug that inhibits protein synthesis. Predict what effect cycloheximide would have on de-etiolation.
- **WHAT IF?** The sexual dysfunction drug Viagra inhibits an enzyme that breaks down cyclic GMP. If tomato leaf cells have a similar enzyme, would applying Viagra to these cells cause a normal de-etiolation of *aurea* mutant tomato leaves?
...
- Fusicoccin is a fungal toxin that stimulates the plasma membrane H+ pumps of plant cells. How may it affect the growth of isolated stem sections?
- **WHAT IF?** If a plant has the double mutation *ctr* and *ein*, what is its triple-response phenotype? Explain your answer.
- **MAKE CONNECTIONS** What type of feedback process is exemplified by the production of ethylene during fruit ripening? Explain. (See Figure 1.10.)
...
- **WHAT IF?** If a plant flowers in a controlled chamber with a daily cycle of 10 hours of light and 14 hours of darkness, is it a short-day plant? Explain.
- **MAKE CONNECTIONS** Plants detect the quality of their light environment by using blue-light photoreceptors and red-light-absorbing phytochromes. After reviewing Figure 10.9, suggest a reason why plants are so sensitive to these colors of light.
...
- Thermal images are photographs of the heat emitted by an object. Researchers have used thermal imaging of plants to isolate mutants that overproduce abscisic acid. Suggest a reason why they are warmer than wild-type plants under conditions that are normally nonstressful.
- A greenhouse worker finds that potted chrysanthemums nearest the aisles are often shorter than those in the middle of the bench. Explain this “edge effect,” a common problem in horticulture.
- **WHAT IF?** If you removed the root cap from a root, would the root still respond to gravity? Explain.
...
- Why do pathogen-infected leaves often appear spotted?
- Chewing insects mechanically damage plants and lessen the surface area of leaves for photosynthesis. In addition, these insects make plants more vulnerable to pathogen attack. Suggest a reason why.
- Many fungal pathogens get food by causing plant cells to become leaky, releasing nutrients into the intercellular spaces. Would it benefit the fungus to kill the host plant in a way that results in all the nutrients leaking out? Explain.
- **WHAT IF?** Suppose a scientist finds that a population of plants growing in a breezy location is more prone to herbivory by insects than a population of the same species growing in a sheltered area. Suggest an explanation.
