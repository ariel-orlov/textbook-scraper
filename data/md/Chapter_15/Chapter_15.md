...
In this chapter, you will learn about how genes are located on chromosomes and will explore the chromosomal basis for the transmission of genes from parents to offspring, including what happens when two genes are linked on the same chromosome. You’ll also learn about sex-linked (X-linked) genes and their inheritance, sex determination, sex chromosomal abnormalities, gene imprinting, and the inheritance of genes in organelles. Before beginning this chapter, you should be able to do the following:

- Describe the process of meiosis (see Concept 13.3 and Figure 13.7).
- Describe what happens during crossing over (see Figure 13.9).
- Explain segregation and independent assortment (see Concept 14.1, Figure 14.5, and Figure 14.8).

The following questions provide a quick check of your basic knowledge in these areas.


1. A cell goes through  S phase, meiosis I, and cytokinesis. As the daughter cells are beginning meiosis II, which of the following is an appropriate description of the contents of each cell?


            Each has half the chromosomes and twice the amount of DNA as the original cell.


That's incorrect. Try again.


**Incorrect.** Review the following material: Homologous pairs separate during meiosis I, reducing the number of chromosome sets from two (diploid) to one (haploid). As each daughter cell begins meiosis II, it has one set of chromosomes—half the chromosomes found in the original cell. However, since each of these chromosomes was duplicated during  S phase, the daughter cell has the same amount of DNA as the original cell.
...
**Correct!** If you had trouble with this question, review the following material: Homologous pairs separate during meiosis I, reducing the number of chromosome sets from two (diploid) to one (haploid). As each daughter cell begins meiosis II, it has one set of chromosomes—half the chromosomes found in the original cell. However, since each of these chromosomes was duplicated during  S phase, the daughter cell has the same amount of DNA as the original cell.
            ...
            Each has half the chromosomes and half the amount of DNA as the original cell.
...
**Incorrect.** Review the following material: Homologous pairs separate during meiosis I, reducing the number of chromosome sets from two (diploid) to one (haploid). As each daughter cell begins meiosis II, it has one set of chromosomes—half the chromosomes found in the original cell. However, since each of these chromosomes was duplicated during  S phase, the daughter cell has the same amount of DNA as the original cell.
            ...
            Each has half the chromosomes and one-fourth the amount of DNA as the original cell.
...
2. During a single crossover event, how many strands of DNA must break? (Recall that DNA is double-stranded.)
...
3. A sexually reproducing animal has two unlinked genes, one for head shape  (H) and one for tail length  (T). Its genotype is  HhTt. Which of the following genotypes for these two genes is possible in a gamete from this organism?
...
- 15.1 Discuss Mendel's laws of inheritance in relation to the behavior of chromosomes during meiosis and fertilization, and explain Morgan's experiments with red- and white-eyed fruit flies.
- 15.2 Describe the inheritance patterns displayed by sex-linked genes and the effects of X inactivation in female mammals.
- 15.3 Explain how linkage of genes and crossing over affect inheritance.
- 15.4 List different types of alterations to chromosome number and structure, and explain how they can cause genetic disorders.
- 15.5 Identify the basis for non-Mendelian inheritance patterns shown by (1) organelle genes and (2) imprinted genes.
