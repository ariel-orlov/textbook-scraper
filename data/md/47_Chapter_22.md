...
In this chapter, you will learn that evolution can be defined as descent with modification, the idea that living species have descended from ancestral species that were different from the present-day species. Before beginning this chapter, you should be able to do the following:

- Explain how organisms inherit traits from their parents (see Concept 14.1 and Concept 14.3).
- Summarize the flow of information from genes to proteins (see Concept 17.1).
- Explain how the scientific process works (see Concept 1.3 and Figure 1.22).

The following questions provide a quick check of your basic knowledge in these areas.


1. A heritable trait is one that


            an organism acquires during its lifetime and passes on to its offspring.
...
**Incorrect.** Review the following material: Transmitted from parents to offspring, genes are the units of inheritance. Thus, for an organism to inherit a characteristic or trait from its parent, that trait must be determined at least in part by genes. “Dominant” does not indicate that a trait is always inherited, but rather describes a version of a gene (allele) that is fully expressed in the phenotype of a heterozygote; an alternate allele whose phenotypic effect is not observed in a heterozygote is said to be recessive.
            ...
            is determined by genetic information encoded in proteins.
...
**Incorrect.** Review the following material: Transmitted from parents to offspring, genes are the units of inheritance. Thus, for an organism to inherit a characteristic or trait from its parent, that trait must be determined at least in part by genes. “Dominant” does not indicate that a trait is always inherited, but rather describes a version of a gene (allele) that is fully expressed in the phenotype of a heterozygote; an alternate allele whose phenotypic effect is not observed in a heterozygote is said to be recessive.
            ...
            is dominant and hence is always inherited.
...
2. What does it mean that organisms have a nearly universal genetic code?
...
**Correct!** If you had trouble with this question, review the following material: Genes are sequences of DNA that encode proteins. Though organisms have different genes and different proteins, all organisms use essentially the same genetic code in the process of transcribing and translating genes into proteins: A particular DNA codon encodes the same amino acid in one species as it does in another.


            Nearly all organisms have the same genes.
...
**Incorrect.** Review the following material: Genes are sequences of DNA that encode proteins. Though organisms have different genes and different proteins, all organisms use essentially the same genetic code in the process of transcribing and translating genes into proteins: A particular DNA codon encodes the same amino acid in one species as it does in another.
            ...
            The genes of nearly all organisms encode the same proteins.
...
**Incorrect.** Review the following material: Genes are sequences of DNA that encode proteins. Though organisms have different genes and different proteins, all organisms use essentially the same genetic code in the process of transcribing and translating genes into proteins: A particular DNA codon encodes the same amino acid in one species as it does in another.
            ...
            Nearly all organisms have the same mRNA.
...
3. A biologist observes that a particular plant species is found in a forest but not in a nearby meadow. She hypothesizes that the plants could grow in the meadow but are not found there because their seeds have yet to land in the meadow. Which of the following would be the most appropriate way to scientifically evaluate this hypothesis?
            ...
            observing how long it takes the seeds to eventually reach the meadow


That's incorrect. Try again.


**Incorrect.** Review the following material: Although it might be useful to know how far the seeds typically travel, this information would not allow you to determine whether the plants could grow in the meadow. Observing how long it takes the seeds to reach the meadow also would not tell you whether these plants could grow in the meadow (and there is no guarantee that the seeds would reach the meadow during the course of your observations). Making a logical argument in support of a hypothesis does not constitute a scientific test of that hypothesis.


            measuring how far the seeds typically travel from their parent plant
...
**Correct!** If you had trouble with this question, review the following material: Scattering seeds in the meadow would be an experiment that tests whether the plants could grow in the meadow if their seeds were to reach that location. Based on the biologist’s hypothesis, you could predict that if the seeds landed in the meadow, the plants would appear there, so this experiment would provide data to support or reject the hypothesis. While it might also be useful to know how far the seeds typically travel, this information would not allow you to determine whether the plants could grow in the meadow. Observing how long it takes the seeds to reach the meadow also would not tell you whether these plants could grow in the meadow (and there is no guarantee that the seeds would reach the meadow during the course of your observations). Finally, making a logical argument in support of a hypothesis does not constitute a scientific test of that hypothesis.


            constructing a logical argument about why her hypothesis must be true
...
- 22.1Compare Darwin's concept of descent with modification to the prevailing ideas of his time.
- 22.2Explain how, over time, natural selection results in organisms' adaptation to their environment.
- 22.3Use examples to show how evolution is supported by scientific evidence.
...
![Timeline showing the intellectual context of Darwin's ideas from 1790 to 1870.](../images/img_0.jpg)
...
![The formation of sedimentary strata and exposure of fossils trapped in these strata are depicted in two images.](../images/img_1.jpg)
...
![A person trims and cuts a bonsai tree into a particular shape.](../images/img_4.jpg)
...
- **WHAT IF?** If you discovered a fossil of an extinct mammal that lived high in the Andes, would you predict that it would more closely resemble present-day mammals from South American jungles or present-day mammals that live high in Asian mountains? Explain.
- **MAKE CONNECTIONS** Review the relationship between genotype and phenotype (see Figures 14.5 and 14.6). Suppose that in a particular pea population, flowers with the white phenotype are favored by natural selection. Predict what would happen over time to the frequency of the white-flower allele (the p allele) in the population.
...
![A soapberry bug with its beak inserted in balloon vine fruit.](../images/img_0.jpg)
...
![Two graphs show the average beak length in museum specimens from each population.](../images/img_1.jpg)
...
![The circular chromosome of clone U S A 300 depicts the complete length of base pairs and adaptive regions.](../images/img_2.jpg)
...
![Mammalian forelimbs shown for human, cat, whale and bat.](../images/img_5.jpg)
...
![Chick embryo (LM) and human embryo shown with arrows to the pharyngeal arches and post-anal tail.](../images/img_6.jpg)
...
![Evolutionary tree for tetrapods with branches explaining evolution of tetrapods, amniotes, reptiles, and birds.](../images/img_7.jpg)
...
![Sugar glider from Australia and flying squirrel from North America. They look similar.](../images/img_10.jpg)
...
![Most mammals represented by a Canis (dog); Cetaceans and even-toed ungulates represented by (b) Pakicetus, (c) Sus (pig), (d) Odocoileus (deer).](../images/img_11.jpg)
...
![An evolutionary tree.](../images/img_12.jpg)
...
![Diacodexis, an early even-toed ungulate (length including tale is approximately 80 centimeters; height is approximately 30 centimeters).](../images/img_15.jpg)
...
![On a tree, Aplochiton (two species; South America) and Lovettia (one species; Tasmania, Australia) share a common ancestor about 55 million years ago. They all share a common ancestor with other genera in the Galaxiidae approximately 69 million years ago.](../images/img_16.jpg)
...
![Guppies are transplanted from pools with pike-cichlids and guppies to pools with killifish, but no guppies prior to the transplant.](../images/img_17.jpg)
...
![Two bar charts show (1) number of colored spots and (2) area of colored spots (millimeters squared) on the y-axis and the source population and transplanted population on the x-axis.](../images/img_18.jpg)
...
- How does evolution account for

- the similar mammalian forelimbs with different functions shown in Figure 22.15 and
- the similar forms of the two distantly related mammals shown in Figure 22.18?
- **WHAT IF?** Fossils show that dinosaurs originated 200–250 million years ago. Would you expect the geographic distribution of early dinosaur fossils to be broad (on many continents) or narrow (on one or a few continents only)? Explain.
