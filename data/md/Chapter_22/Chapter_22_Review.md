...
- Darwin proposed that life’s diversity arose over long periods of time from ancestral species through natural selection, a departure from prevailing views. For example, Cuvier studied ******fossils**
 but denied that ******evolution** occurs; he proposed that sudden catastrophic events in the past caused species to disappear from an area. Lamarck hypothesized that species evolve, but the underlying mechanisms he proposed are not supported by evidence.
...
- Researchers have directly observed natural selection leading to evolution in many studies in diverse organisms.
...
- Evolutionary theory can explain some ******biogeographic**
 patterns.
