...
Plants not only have affected the recovery of regions such as Mount St. Helens but also have transformed Earth. Continuing the saga of how this occurred, this chapter follows the emergence and diversification of the group to which fireweed belongs, the seed plants.


## Get Ready for This Chapter

In this chapter, you will learn about the general characteristics and evolutionary history of seed plants, as well as their impact on human society. Before beginning this chapter, you should be able to do the following:
****

- Distinguish between analogy, homology, and descent with modification (see Concept 22.3).
- Describe a life cycle that exhibits alternation of generations (see Figure 13.6b and Figure 29.5).
- Define the terms *gametophyte* and *sporophyte*, explaining how each contributes to sexual reproduction in plants (see Figure 29.5).

The following questions provide a quick check of your basic knowledge in these areas.


1. What is the process by which a trait present in an ancestral organism is modified by natural selection over time in descendants of that ancestor?
...
2﻿. A life cycle that exhibits alternation of generations includes the following:


            haploid multicellular organisms only


That's incorrect. Try again.


**Incorrect.** Review the following material: The life cycles of all plants alternate between two generations of distinct multicellular organisms: multicellular haploid gametophytes and multicellular diploid sporophytes. Each generation gives rise to the other. That is why this process is called alternation of generations.


            multicellular haploid organisms and a diploid unicellular stage
...
**Incorrect.** Review the following material: The life cycles of all plants alternate between two generations of distinct multicellular organisms: multicellular haploid gametophytes and multicellular diploid sporophytes. Each generation gives rise to the other. That is why this process is called alternation of generations.
            ...
            a unicellular haploid stage and diploid multicellular organisms
...
3. In plants, the ________ produces haploid gametes (eggs and sperm) by mitosis, whereas the ________ produces haploid spores by meiosis.
...
- 30.1Explain how seeds and pollen grains were key adaptations for plants.
- 30.2Characterize gymnosperms and their life cycles.
- 30.3Describe the structure and function of flowers and fruits.
