...
- **********Signal transduction pathways**
 are crucial for many processes. Bacterial cells can sense the local density of bacterial cells (quorum sensing). Signaling during yeast cell mating has much in common with processes in multicellular organisms, suggesting an early evolutionary origin of signaling mechanisms.
