...
A small box shows the highly diverse subgroups that eukaryotes are divided into: Excavata, SAR, Archaeplastida, and Unikonta, shown similar to a branching phylogenetic tree.
...
In this chapter, you will learn about the origin and evolutionary history of protists, as well as their impact on ecosystems and human societies. Before beginning this chapter, you should be able to do the following:

- Explain the concept of domains (see Concept 26.6, Figure 26.21).
- Describe the endosymbiotic origin of mitochondria and plastids (see Concept 25.3, Figure 25.10).
- Compare the outcomes of mitosis and meiosis (see Figure 13.10).

The following questions provide a quick check of your basic knowledge in these areas.


1. Which of the following domains consists of all the organisms whose cells have true nuclei?
...
Incorrect. Review the following material: The domain Bacteria includes most of the currently known prokaryotes, while the domain Archaea consists of a diverse group of prokaryotic organisms that inhabit a wide variety of environments. The domain Eukarya includes many groups of single-celled organisms as well as plants, fungi, and animals.
...
2. According to the hypothesis of serial endosymbiosis, which of the following was a key initial step that best describes the origin of chloroplasts?
...
**Correct!** If you had trouble with this question, review the following material: Evidence indicates that the eukaryotes originated by endosymbiosis when a prokaryotic cell engulfed a small aerobic, heterotrophic bacterium whose descendants evolved into an organelle found in all eukaryotes, the mitochondrion. The prokaryotic ancestor of the mitochondrion probably entered the host cell as undigested prey or an internal parasite. Later, a eukaryotic host cell engulfed a photosynthetic bacterium, leading to the evolution of plastids.
            ...
            A eukaryotic host cell engulfed an aerobic, photosynthetic bacterium. (new correct answer)
...
3. A diploid  (2n) cell divides by meiosis, producing four daughter cells. Next, each daughter cell divides by mitosis, producing a total of eight granddaughter cells. Which of the following statements about the granddaughter cells is true?


            All of the granddaughter cells are genetically identical.


That's incorrect. Try again.


**Incorrect.** Review the following material: In meiosis, a parent cell produces four daughter cells, each of which has half the chromosome number of the parent cell. In mitosis, a parent cell produces two daughter cells, each of which is genetically identical to the parent cell.


Each granddaughter cell is diploid  (2n).
...
**Correct!** If you had trouble with this question, review the following material: In meiosis, a parent cell produces four daughter cells, each of which has half the chromosome number of the parent cell; in this case, the diploid  (2n) parent cell produces four daughter cells, each of which is haploid  (n). In mitosis, a parent cell produces two daughter cells that are genetically identical to the parent cell; in this case, the four haploid daughter cells produce a total of eight granddaughter cells, each of which is haploid  (n).
            ...
            Four of the granddaughter cells are genetically identical.
...
- 28.1Describe the process of secondary endosymbiosis and explain its role in eukaryotic history.
- 28.2Characterize the excavates.
- 28.3Give examples of the protists classified in SAR.
- 28.4Describe characteristics of red and green algae.
- 28.5Identify and describe the closest eukaryotic relatives of fungi and animals.
- 28.6Give examples of ecological roles played by protists.
