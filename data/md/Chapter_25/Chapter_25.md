...
Taken together, such changes provide a grand view of the evolutionary history of life. We’ll examine that history in this chapter, beginning with a discussion of hypotheses regarding the origin of life. This is the most speculative topic of the entire unit, because no fossil evidence of that seminal episode exists.


## Get Ready for This Chapter

In this chapter, you will learn about the history of life on Earth, focusing on evidence from the fossil record and mechanisms that have shaped the rise and fall of different groups of organisms over time. Before beginning this chapter, you should be able to do the following:

- Distinguish between prokaryotic and eukaryotic organisms (see Concept 6.2, Figure 6.5, and Figure 6.8).
- Explain the process of speciation (see Concept 24.2, Figure 24.5).
- Interpret an evolutionary tree (see Concept 22.3, Figure 22.17).
...
**Incorrect.** Review the following material: A cell wall, DNA, and a plasma membrane can all be found in prokaryotic as well as eukaryotic cells.
...
**Correct!** If you had trouble with this question, review the following material: A cell wall, DNA, and a plasma membrane can all be found in prokaryotic as well as eukaryotic cells. But only eukaryotes have membrane-enclosed organelles such as a true nucleus, mitochondria, and chloroplasts.
...
2﻿. Which of the following can promote allopatric speciation but *not* sympatric speciation?
...
**Incorrect.** Review the following material: Allopatric speciation occurs when a population becomes geographically isolated from other members of its species; in contrast, sympatric speciation occurs in populations that are not geographically isolated.
...
3. Based on the evolutionary tree shown, mammals share a most recent common ancestor with which groups?
...
**Correct!** If you had trouble with this question, review the following material: Mammals share a more recent common ancestor with lizards and snakes, crocodiles, and birds than they do with amphibians. This is indicated by the branch point that splits into the branches leading to the mammals and to the lizards and snakes, crocodiles, and birds, which is located to the right of the branch point that represents the most common ancestor of amphibians and the mammal and reptile lineages. Hence, mammals are more closely related to lizards and snakes, crocodiles, and birds than they are to amphibians. Note also that mammals are as closely related to lizards and snakes as they are to crocodiles or birds.


            amphibians and lizards and snakes


That's incorrect. Try again.


**Incorrect.** Review the following material: Mammals share a more recent common ancestor with lizards and snakes, crocodiles, and birds than they do with amphibians. This is indicated by the branch point that splits into the branches leading to the mammals and to the lizards and snakes, crocodiles, and birds, which is located to the right of the branch point that represents the most common ancestor of amphibians and the mammal and reptile lineages.
...
- 25.1Describe steps by which simple cells may have originated from nonliving materials.
- 25.2Explain what fossils are, how they are dated, and what the fossil record can reveal about life's history.
- 25.3Identify when the origin of single and multicelled organisms and the colonization of land occurred, and explain the significance of these events.
- 25.4Explain how plate tectonics, mass extinctions, and adaptive  radiations have affected Earth's life.
- 25.5Describe how changes in the sequence or regulation of genes can result in major changes in body form.
- 25.6Use examples to show how novel and complex structures can arise by descent with modification.
