...
- **Autotrophs** (“producers”) produce their organic molecules from CO2 and other inorganic raw materials; plants are *photoautotrophs* that use light energy to do this. ******Heterotrophs**
 (consumers, including decomposers) are unable to make their own food and live on compounds produced by others.
...
- C4 and CAM plants are adopted to hot, dry climates.
