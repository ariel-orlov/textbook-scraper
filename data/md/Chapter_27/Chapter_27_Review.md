...
| --- | --- |
| Fimbriae | Hair-like appendages on the surface of the cell that help cells adhere to other cells or substrate |
...
| Sex Pilus | String-like appendage (in appearance) that facilitates sexual conjugation |
...
| Flagella | Whip-like (in appearance) structures used by most motile bacteria or propulsion; many species can move towards or away from |


- Many **prokaryotic**
 species can reproduce quickly by binary fission, leading to the formation of extremely large populations.
