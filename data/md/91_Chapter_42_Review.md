...
Oxygen-poor blood. In the heart, blood moves from the right atrium to the right ventricle and is then pumped out via the pulmonary artery to the alveolar capillaries in the lungs. As blood passes along the alveolar capillaries it takes up oxygen from inhaled air and becomes oxygen-rich. C O 2 is also unloaded and exhaled.


Oxygen-rich blood. From the alveolar capillaries, blood returns to the heart via the pulmonary veins and enters the left atrium. It then travels to the left ventricle and is pumped out via the systemic arteries to the systemic capillaries. As blood passes along the systemic capillaries, body tissue cells take up O 2 from the blood and C O 2 passes from the tissue cells to the blood. The oxygen-rich blood becomes oxygen-poor as it travels across the systemic capillary beds.


Oxygen-poor blood. Oxygen poor blood returns to the heart from the systemic capillaries via that systemic veins. It enters the heart at the right atrium to begin the double circuit again.


- During each **cardiac cycle**, a complete sequence of the heart’s pumping and filling, there is a period of ventricular contraction, called **systole**, and a period of ventricular relaxation, called **diastole**. Heart function can be assessed by measuring the **pulse** (number of times the heart beats each minute) and **cardiac output**(volume of blood pumped by each ventricle per minute).
- The heartbeat originates with impulses at the **sinoatrial node** (**SA)** (pacemaker) of the right atrium. They trigger atrial contraction, are delayed at the **atrioventricular node** (**AV)**, and are then conducted along the bundle branches and Purkinje fibers, triggering ventricular contraction. The nervous system, hormones, and body temperature affect pacemaker activity.
...
- Blood vessels have structures well adapted to function. Capillaries have narrow diameters and thin walls that facilitate exchange. Arteries contain thick elastic walls that maintain blood pressure. Veins contain one-way valves that contribute to the return of blood to the heart.
- The velocity of blood flow is lowest in the capillary beds as a result of their large total cross-sectional area. Blood pressure is altered by changes in cardiac output and by variable constriction of arterioles.
...
- Whole blood consists of cells and cell fragments (**platelets**) suspended in a liquid matrix called ******plasma**. Plasma proteins influence blood pH, osmotic pressure, and viscosity, and they function in lipid transport, immunity (antibodies), and blood clotting (fibrinogen). Red blood cells, or ******erythrocytes**, transport O2. Five types of white blood cells, or ******leukocytes**, function in defense against microorganisms and foreign substances in the blood. Platelets function in blood clotting, a cascade of reactions that converts plasma fibrinogen to fibrin.
...
- In the lungs, gradients of partial pressure favor the net diffusion of O2 into the blood and CO2 out of the blood. The opposite situation exists in the rest of the body. **Respiratory pigments** such as hemocyanin and hemoglobin bind O2, greatly increasing the amount of O2 transported by the circulatory system.
- Evolutionary adaptations enable some animals to satisfy extraordinary O2 demands. Deep-diving mammals stockpile O2 in blood and other tissues and deplete it slowly.
...
- **DRAW IT** ***Science Practice 4*** **Plot** blood pressure against time for one cardiac cycle in humans, drawing separate lines for the pressure in the aorta, the left ventricle, and the right ventricle. Below the time axis, add a vertical arrow pointing to the time when you expect a peak in atrial blood pressure.
- **CONNECT TO BIG IDEA 1** One opponent of the movie monster Godzilla is Mothra, a mothlike creature with a wingspan of several dozen meters. The largest known insects were Paleozoic dragonflies with half-meter wingspans. Focusing on respiration and gas exchange, **explain** why giant insects are improbable.
- **SCIENTIFIC INQUIRY • INTERPRET THE DATA** ***Science Practices 4 & 6*** The hemoglobin of a human fetus differs from adult hemoglobin. **Compare** the dissociation curves of the two hemoglobins in the graph at right. **Describe** how they differ, and **propose** **a hypothesis** to explain the benefit of this difference.


![Graph depicts the dissociation curves of hemoglobin for a fetus and mother. For all O 2 saturation levels, fetal partial pressure of oxygen is less than the mother’s.](../images/img_0.jpg)


The x-axis is partial pressure of oxygen in milligrams of mercury, ranging from 0 to 100 with increments every 20. The y-axis is O 2 saturation of hemoglobin (percent). The lines for the fetus and the mother are roughly parallel, except the fetal line is to the left of the mother’s line. The lines for both the fetus and the mother climb steeply from near 10% O 2 saturation and 10 milligrams of mercury until about 70% O 2 saturation, when they begin to flatten out slightly (at just over 20 milligrams of mercury for the fetus and just over 40 milligrams of mercury for the mother). For all O 2 saturation levels, fetal partial pressure of oxygen is less than the mother’s.
...
- **CONNECT TO BIG IDEA 4** Some athletes prepare for competition at sea level by sleeping in a tent in which PO2 is kept low. When climbing high peaks, some mountaineers breathe from bottles of pure O2. In a short essay (100–150 words), **relate** these behaviors to the mechanism of O2 transport in the human body and to physiological interactions with our gaseous environment.
- **SYNTHESIZE YOUR KNOWLEDGE*****Science Practice 6***


![A spider.](../images/img_1.jpg)
