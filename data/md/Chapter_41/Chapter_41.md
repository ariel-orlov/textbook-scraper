...
In this chapter, you will learn how animals take in and digest food, move nutrients into cells, and allocate molecules for breakdown, biosynthesis, or storage. Before beginning this chapter, you should be able to do the following:

- Describe the structural organization of nucleic acids, proteins, polysaccharides, and fats (see Figure 5.6, Figure 5.9, Figure 5.15, and Figure 5.23).
- Distinguish between an acidic and a basic solution and between a hydrophobic and a hydrophilic molecule (see Concept 3.2).
- Outline the flow of energy through animal bodies (see Concept 9.1 and Figure 9.1).

The following questions provide a quick check of your basic knowledge in these areas.


1. Proteins consist of amino acids linked to
...
**Incorrect.** Review the following material: Proteins are a macromolecule constructed from one type of monomer linked into unbranched polymers by peptide bonds.
...
**Correct!** If you had trouble with this question, review the following material: Proteins are a macromolecule constructed from amino acids linked in unbranched polymers. The bond between amino acids is called a peptide bond, so a polymer of amino acids is called a polypeptide. Sugars, phosphates, and fatty acids are components of other macromolecules.
...
2. Which of the following is hydrophobic and therefore insoluble in water?
...
**Incorrect.** Review the following material: Nonpolar molecules tend not to mix stably with water-based substances and thus are hydrophobic.
...
3﻿. Animals obtain the energy they need for growth by
...
**Incorrect.** Review the following material: Potential energy is stored in the bonds of complex organic molecules and can be captured when those bonds are broken.
...
- 41.1Describe the dietary needs for chemical energy, organic building blocks, and the four classes of essential nutrients.
- 41.2Distinguish the main feeding mechanisms of animals, and define four stages of food processing.
- 41.3Describe the major functions of each compartment in the mammalian digestive system.
- 41.4Use examples to demonstrate how vertebrate digestive systems are adapted to diet.
- 41.5Provide examples of negative feedback in the regulation of nutrient intake, processing, and storage.
