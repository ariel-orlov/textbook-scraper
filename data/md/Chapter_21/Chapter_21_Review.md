...
### Concept 21.2: Scientists use bioinformatics to analyze genomes
and their functions
...
### Concept 21.3: Genomes vary in size, number of genes, and gene
density
...
| --- | --- | --- | --- |
| Genome size | Most are 1 to 6 megabytes | Most are 1 to 6 megabytes | Most are 10 to 4000 megabytes |
| Number of genes | 1500 to 7500 | 1500 to 7500 | Most are 5000 to 45,000 |
| Gene diversity | Higher than in eukaryotes | Higher than in eukaryotes | Lower than in prokaryotes (Within eukaryotes, lower density is correlated with large genomes.) |
| Introns | None in protein-coding genes | Present in some genes | Present in most genes of multicellular eukaryotes, but only in some genes of unicellular eukaryotes |
| Other noncoding D N A | Very little | Very little | Can exist in large amounts; generally more repetitive noncoding D N A in multicellular eukaryotes |


*Compare genome size, gene number, and gene density (a) in the three domains and (b) among eukaryotes.*
...
Alpha-globin gene family. Chromosome 16 regions, left to right: Noncoding region; zeta gene with arrow to embryo; noncoding region; psi zeta gene; noncoding region; psi alpha 2 pseudogene; noncoding region; psi alpha 1 pseudogene; noncoding region; alpha 2 gene with arrow to fetus and adult; noncoding region; alpha 1 gene with arrow to fetus and adult; noncoding region; psi theta pseudogene; noncoding region.
